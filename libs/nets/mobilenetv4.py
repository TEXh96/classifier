...
__all__ = ['MobileNetV4','mobilenetv4_conv_small', 'mobilenetv4_conv_medium', 'mobilenetv4_conv_large']
...
def MobileNetV4_my(pretrained=True, num_classes=4):
    model = mobilenetv4_conv_small(pretrained=True,num_classes=1000)
    #model = mobilenet_v3_large(pretrained=True,num_classes=1000)
    # print("done")
